function SkeletonCard({ index }) {
  return (
    <div
      className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-lg p-4 mb-2.5 animate-pulse"
    ...
    >
      ...
      <div className="h-1.5 w-full bg-slate-100 dark:bg-gray-700 rounded mb-3"></div>
